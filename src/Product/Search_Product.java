...
public class Search_Product extends JPanel {
	...
	public Search_Product() {
		...
		btnSearchByName.setBackground(Color.BLACK);
		
		btnSearchByName.setForeground(Color.GREEN);
		...
		btnSearchById_1.setBackground(Color.BLACK);
		...
		btnSearchById_1.setForeground(Color.GREEN);
