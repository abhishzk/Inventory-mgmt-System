...
public class MainFrame extends JFrame {
	...
	public void init() {
		...
		mnEmployees.setBackground(Color.BLACK);
		menuBar.add(mnEmployees);
		JMenuItem menu_Add_Employee = new JMenuItem("Add Employee");
		menu_Add_Employee.setBackground(Color.BLACK);
		...
		mntmSearchEmployee.setBackground(Color.BLACK);
		...
		menu_Add_Products.setBackground(Color.BLACK);
		...
		mntmSearchProducts.setBackground(Color.BLACK);
		...
		mntmAddCustomer.setForeground(Color.GREEN);
		mntmAddCustomer.setFont(new Font("Calibri", Font.BOLD, 18));
		mntmAddCustomer.setBackground(Color.BLACK);
		...
		mntmSearchCustomer.setBackground(Color.BLACK);
		...
		mnReports.setBackground(Color.BLACK);
		...
		mntmProductsReport.setBackground(Color.BLACK);
		...
		mntmCustomerReport.setBackground(Color.BLACK);
		...
		mntmEmployeereport.setBackground(Color.BLACK);
