...
public class MainMenu extends JPanel {
	...
	public MainMenu() {
		...
		btnProductHashTable.setBackground(Color.BLACK);
		...
		btnProductHashTable.setForeground(Color.GREEN);
		...
		lblStoreManagementSystem.setForeground(Color.GREEN);
		lblStoreManagementSystem.setFont(new Font("Calibri", Font.BOLD, 24));
		lblStoreManagementSystem.setBounds(32, 49, 412, 50);
		...
		btnEmployees.setForeground(Color.GREEN);
		...
		btnCustomers.setForeground(Color.GREEN);
