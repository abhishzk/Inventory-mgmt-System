...
public class DirectoryHash extends JFrame implements Serializable {
	...
	private void initialize() {
		...
		teleFrame.getContentPane().setForeground(Color.GREEN);
		teleFrame.getContentPane().setFont(new Font("Calibri", Font.PLAIN, 15));
		teleFrame.getContentPane().setBackground(Color.BLACK);
		...
		lblNewLabel.setBounds(100, 29, 311, 41);
		...
		lblNewLabel_2.setBounds(23, 102, 168, 17);
		...
		lblNewLabel_3.setBounds(23, 152, 168, 18);
		...
		btnIterate.setForeground(Color.GREEN);
		btnIterate.setBackground(Color.BLACK);
