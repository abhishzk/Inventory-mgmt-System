...
public class Add_Employee extends JPanel {
	...
	public Add_Employee() {
		...
		btnEmployee_Ins.setBackground(Color.BLACK);

		btnEmployee_Ins.setForeground(Color.GREEN);
		...
		btn_Employee_Back.setBackground(Color.BLACK);
		btn_Employee_Back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MainFrame.backHome();
			}
		});
		btn_Employee_Back.setForeground(Color.GREEN);
